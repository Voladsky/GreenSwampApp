...
{
    /// <inheritdoc />
    public partial class LoginAdding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_claims_auth_UserId",
                        column: x => x.UserId,
                        principalTable: "auth",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_logins_auth_UserId",
                        column: x => x.UserId,
                        principalTable: "auth",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_tokens_auth_UserId",
                        column: x => x.UserId,
                        principalTable: "auth",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_roles_auth_UserId",
                        column: x => x.UserId,
                        principalTable: "auth",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
